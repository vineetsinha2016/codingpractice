 ...
 * The cost required to connect 2 ropes is equal to sum of their lengths. The length of this connected rope is
 ...
 * Output: 20
 *
 * Step 1: Initialize totalCost to 0 and run while loop on queue if size is more than one. keep looping
 * Step 2: poll two elements , add them and put into a temp variable
 * Step 3: add this temp to existing queue and add it to totalCost.
